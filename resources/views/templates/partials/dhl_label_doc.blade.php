...
@endphp
<table style="width:595pt; font-family:Arial,Helvetica,sans-serif; font-size:7.5pt; color:#000; border:1pt solid #999; border-collapse:collapse;">
    ...
    <td colspan="3" style="padding:0;">
        <table style="width:100%; border-collapse:collapse;">
            ...
            <tr style="border-bottom:1pt solid #e8e8e8;">
                ...
                <td style="width:100pt; padding:5pt 12pt; text-align:right; font-weight:bold; font-family:'Courier New',monospace; font-size:7.5pt; color:#666; vertical-align:middle; white-space:nowrap;">{{ $cur }}&nbsp;{{ number_format($goodsValue,2) }}</td>
            </tr>
            @endif
            @if($shippingFee)
            <tr style="border-bottom:1pt solid #e8e8e8;">
                ...
                <td style="width:100pt; padding:5pt 12pt; text-align:right; font-weight:bold; font-family:'Courier New',monospace; font-size:7.5pt; vertical-align:middle; white-space:nowrap;">{{ $cur }}&nbsp;{{ number_format($shippingFee,2) }}</td>
            </tr>
            @endif
            @if($insuranceFee)
            <tr style="border-bottom:1pt solid #e8e8e8;">
                ...
                <td style="width:100pt; padding:5pt 12pt; text-align:right; font-weight:bold; font-family:'Courier New',monospace; font-size:7.5pt; vertical-align:middle; white-space:nowrap;">{{ $cur }}&nbsp;{{ number_format($insuranceFee,2) }}</td>
            </tr>
            @endif
            @if($customsDuties)
            <tr style="border-bottom:1pt solid #e8e8e8;">
                ...
                <td style="width:100pt; padding:5pt 12pt; text-align:right; font-weight:bold; font-family:'Courier New',monospace; font-size:7.5pt; vertical-align:middle; white-space:nowrap;">{{ $cur }}&nbsp;{{ number_format($customsDuties,2) }}</td>
            </tr>
            @endif
            <tr>
                <td style="background:#1a1a1a; color:#FFCC00; font-size:8pt; font-weight:bold; padding:7pt 12pt; letter-spacing:1pt; text-transform:uppercase; vertical-align:middle;">Total Amount Due</td>
                <td style="width:100pt; background:#1a1a1a; color:#FFCC00; font-size:10pt; font-weight:bold; padding:7pt 12pt; text-align:right; font-family:'Courier New',monospace; vertical-align:middle; letter-spacing:.5pt; white-space:nowrap;">{{ $cur }}&nbsp;{{ number_format($totalFeesDue,2) }}</td>
            </tr>
        </table>
    </td>
</tr>
